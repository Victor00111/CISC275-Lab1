...
*/
const yourName : String = "Victor Tung";
let yourPronouns : String = "He/Him";
const yourMajor : String = "Computer Science BS";
let classification : String = "Sophmore";
let oneExcite : String = "Making my own website";
let anyConcerns : String = "Learning how to use Github";
let funFact : String = "I have a black belt in Tawkwondo";
